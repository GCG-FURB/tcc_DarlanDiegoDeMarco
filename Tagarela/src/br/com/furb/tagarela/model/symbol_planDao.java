...
*/
public class symbol_planDao extends AbstractDao<symbol_plan, Void> {

    public static final String TABLENAME = "SYMBOL_PLAN";

    /**
     * Properties of entity symbol_plan.<br/>
    ...
    */
    ...
    public symbol_planDao(DaoConfig config) {
        super(config);
    }
    
    public symbol_planDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, symbol_plan entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public symbol_plan readEntity(Cursor cursor, int offset) {
        symbol_plan entity = new symbol_plan( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, symbol_plan entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(symbol_plan entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(symbol_plan entity) {
        return null;
    }
