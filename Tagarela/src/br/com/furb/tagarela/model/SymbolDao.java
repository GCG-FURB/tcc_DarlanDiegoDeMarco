...
public class SymbolDao extends AbstractDao<Symbol, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Sincronized = new Property(11, Boolean.class, "sincronized", false, "SINCRONIZED");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SYMBOL' (" + //
                ...
                "'SINCRONIZED' INTEGER);"); // 11: sincronized
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Symbol entity) {
        ...
        if (sincronized != null) {
            stmt.bindLong(12, sincronized ? 1l: 0l);
        }
    }
    ...
    public Symbol readEntity(Cursor cursor, int offset) {
        Symbol entity = new Symbol( //
            ...
            cursor.isNull(offset + 11) ? null : cursor.getShort(offset + 11) != 0 // sincronized
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Symbol entity, int offset) {
        ...
        entity.setSincronized(cursor.isNull(offset + 11) ? null : cursor.getShort(offset + 11) != 0);
     }
