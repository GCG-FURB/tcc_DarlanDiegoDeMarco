...
public class SymbolDao extends AbstractDao<Symbol, Void> {
    ...
    */
    public static class Properties {
        ...
        public final static Property IsGeneral = new Property(1, Boolean.class, "isGeneral", false, "IS_GENERAL");
        ...
        public final static Property Sound = new Property(5, byte[].class, "sound", false, "SOUND");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'SYMBOL' (" + //
                ...
                "'IS_GENERAL' INTEGER," + // 1: isGeneral
                "'NAME' TEXT," + // 2: name
    ...
    protected void bindValues(SQLiteStatement stmt, Symbol entity) {
        ...
        if (isGeneral != null) {
            stmt.bindLong(2, isGeneral ? 1l: 0l);
        }
    ...
    public Symbol readEntity(Cursor cursor, int offset) {
        Symbol entity = new Symbol( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getShort(offset + 1) != 0, // isGeneral
            ...
            cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5), // sound
    ...
    public void readEntity(Cursor cursor, Symbol entity, int offset) {
        ...
        entity.setIsGeneral(cursor.isNull(offset + 1) ? null : cursor.getShort(offset + 1) != 0);
        ...
        entity.setSound(cursor.isNull(offset + 5) ? null : cursor.getBlob(offset + 5));
