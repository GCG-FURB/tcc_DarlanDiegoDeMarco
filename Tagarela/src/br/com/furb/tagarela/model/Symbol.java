...
public class Symbol {
	...
	public Symbol(Integer serverID, Integer userID, Boolean isGeneral,
			String name, String videoLink, byte[] picture, byte[] sound,
			long categoryID, String ascRepresentation, Integer alphaID,
			Boolean sincronized) {
	...
	public Category getCategory() {
		...
		if (category__resolvedKey == null
				|| !category__resolvedKey.equals(__key)) {
			if (daoSession == null) {
