...
public class Symbol {
    ...
    public Symbol(Long id, Integer serverID, Integer userID, Boolean isGeneral, String name, String videoLink, byte[] picture, byte[] sound, long categoryID, String ascRepresentation, Integer alphaID, Boolean sincronized) {
        this.id = id;
