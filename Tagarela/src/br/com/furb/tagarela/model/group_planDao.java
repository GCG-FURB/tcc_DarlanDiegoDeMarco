...
*/
public class group_planDao extends AbstractDao<group_plan, Void> {

    public static final String TABLENAME = "GROUP_PLAN";

    /**
     * Properties of entity group_plan.<br/>
    ...
    */
    ...
    public group_planDao(DaoConfig config) {
        super(config);
    }
    
    public group_planDao(DaoConfig config, DaoSession daoSession) {
    ...
    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, group_plan entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public group_plan readEntity(Cursor cursor, int offset) {
        group_plan entity = new group_plan( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, group_plan entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Void updateKeyAfterInsert(group_plan entity, long rowId) {
    ...
    /** @inheritdoc */
    @Override
    public Void getKey(group_plan entity) {
        return null;
    }
