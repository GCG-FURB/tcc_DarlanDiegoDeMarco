...
public class ObservationDao extends AbstractDao<Observation, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Sincronized = new Property(6, Boolean.class, "sincronized", false, "SINCRONIZED");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "'OBSERVATION' (" + //
                ...
                "'SINCRONIZED' INTEGER);"); // 6: sincronized
    }
    ...
    protected void bindValues(SQLiteStatement stmt, Observation entity) {
        ...
        if (sincronized != null) {
            stmt.bindLong(7, sincronized ? 1l: 0l);
        }
    }
    ...
    public Observation readEntity(Cursor cursor, int offset) {
        Observation entity = new Observation( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6) != 0 // sincronized
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Observation entity, int offset) {
        ...
        entity.setSincronized(cursor.isNull(offset + 6) ? null : cursor.getShort(offset + 6) != 0);
     }
