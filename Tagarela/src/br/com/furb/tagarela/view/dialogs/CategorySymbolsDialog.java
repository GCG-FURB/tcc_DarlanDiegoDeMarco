...
public class CategorySymbolsDialog extends DialogFragment {
	...
	public Dialog onCreateDialog(Bundle savedInstanceState) {
		...
		View view = getActivity().getLayoutInflater().inflate(R.layout.activity_view_symbols, null);
		setupGridView(view);
	...
	private void setupGridView(View view) {
		QueryBuilder queryBuilder = DaoProvider.getInstance(null).getSymbolDao().queryBuilder();
		...
		GridView gridView = (GridView) view.findViewById(R.id.symbolsViewer);
